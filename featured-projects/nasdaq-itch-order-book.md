...
| **Post-Decode Core Latency** | **5 Clock Cycles (16.0 ns)** |
...
- Maintains record of shares at each price tick in the range \[price_base, price_base + tick_size * (L2_MEM_SIZE - 1)\]
...
At 32 bits per clock, a clock of 3.2 ns = 312. MHz, corresponding to 10Gb/s max throughput.
...
<img src="/assets/Resource Utilization 2.png" width="800" alt="Resource Utilization">
